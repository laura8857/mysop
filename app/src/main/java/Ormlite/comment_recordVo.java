...
//嚙踐�count嚙踝蕭
@DatabaseTable(tableName = "comment_record")
public class comment_recordVo extends MDVo implements Serializable
{
	public static final String FIELD_Comment_number ="Comment_number";
	...
	@DatabaseField(columnName = FIELD_Comment_number, canBeNull = false)
	...
	private String Collection_time;//Email
